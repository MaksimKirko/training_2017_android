...
public class NewFriendsCursorLoader extends CursorLoader {
    ...
    public Cursor loadInBackground() {
        return getContext().getContentResolver().query(FriendsContentProvider.FRIENDS_CONTENT_URI, null, null, null, DBHelper.FRIENDS_TABLE_FIELD_LAST_SEEN + " DESC LIMIT 10");
    }
}