package com.github.maximkirko.training_2017_android.activity.intro;
...
public class IntroActivity extends AppCompatActivity {
    ...
    public static final String IS_FIRST_LAUNCH_PREFERENCE = "IS_FIRST_LAUNCH_PREFERENCE";
    ...
    private void addBottomDots(int currentPage) {
        ...
        int colorActive = ContextCompat.getColor(this, R.color.colorIntroDotsActive);
        int colorInactive = ContextCompat.getColor(this, R.color.colorIntroDotsInactive);
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getString(R.string.intro_button_got_it_text));
                btnSkip.setVisibility(View.GONE);
            } else {
                // still pages are left
                btnNext.setText(getString(R.string.intro_button_next_text));
