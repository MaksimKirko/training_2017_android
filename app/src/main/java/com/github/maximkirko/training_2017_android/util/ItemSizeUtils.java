...
public final class ItemSizeUtils {

    private static final int HORIZONTAL_SPACE_NUMBER = 2;
    private static final int HORIZONTAL_ITEM_NUMBER = 1;
    ...
    public static CardView.LayoutParams getLayoutParams(@NonNull Context context) {
        int spaceHorizontal =
                context.getResources().getDimensionPixelSize(R.dimen.margin_friendslist_item_card);
