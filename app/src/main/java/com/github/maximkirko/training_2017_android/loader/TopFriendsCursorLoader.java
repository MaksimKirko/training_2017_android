...
public class TopFriendsCursorLoader extends CursorLoader {
    ...
    public Cursor loadInBackground() {
        return getContext().getContentResolver().query(FriendsContentProvider.FRIENDS_CONTENT_URI, null, null, null, DBHelper.FRIENDS_TABLE_FIELD_RATING + " DESC LIMIT 10");
    }
}